    ...
    <div className={`w-full ${className}`}>
            ...
            label && (
                <label 
                    className={`mb-2 block text-sm font-medium  
                        ${isAuthPage ? 'text-slate-300' : 'text-slate-700 dark:text-slate-300'}
                    `}
                >
                    {label}
                </label>
        ...
        <div className='relative'>
            ...
            <input 
                ...
                placeholder:text-slate-400 transition-colors focus:border-blue-500
                ...
                ${isAuthPage ? 'text-slate-200' : 'text-slate-900'}
